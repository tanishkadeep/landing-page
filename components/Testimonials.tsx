...
const Testimonials = () => {
  return (
    <div className="pt-12">
      <div className="flex flex-col items-center px-28 pb-10">
      ...
      <div className="flex items-center justify-center overflow-x-hidden pb-28 gap-4 [mask-image:linear-gradient(to_bottom,transparent,black,transparent)]">
